...
[cite_start]I am a passionate Computer Science student and developer [cite: 1] [cite_start]with a focus on building scalable web applications and exploring modern AI technologies[cite: 5, 14].

---

### 🎓 Education
* [cite_start]**B-Tech in Computer Science and Engineering**   
    *Dr. [cite_start]B. C. Roy Engineering College, Durgapur* (2023–2027) 
* [cite_start]**XII (CBSE)**   
    [cite_start]*DAV Model School, Durgapur* (2022) 
* [cite_start]**X (ICSE)**   
    [cite_start]*Carmel Convent High School, Durgapur* (2020) 
...
| **Web Dev** | [cite_start]![React](https://img.shields.io/badge/-React-61DAFB?logo=react&logoColor=black) ![Node.js](https://img.shields.io/badge/-Node.js-339933?logo=node.js&logoColor=white) ![Spring Boot](https://img.shields.io/badge/-Spring%20Boot-6DB33F?logo=springboot&logoColor=white) ![Express](https://img.shields.io/badge/-Express-000000?logo=express&logoColor=white) [cite: 7, 8] |
| **AI / ML** | [cite_start]![LangChain](https://img.shields.io/badge/-LangChain-1C3C3C?logo=chainlink) ![Neo4j](https://img.shields.io/badge/-Neo4j-008CC1?logo=neo4j&logoColor=white) **RAG • LLM Integration • Prompt Engineering • OCR** [cite: 11, 14, 15] |
| **Tools & DB** | [cite_start]![MongoDB](https://img.shields.io/badge/-MongoDB-47A248?logo=mongodb&logoColor=white) ![Git](https://img.shields.io/badge/-Git-F05032?logo=git&logoColor=white) **RESTful APIs • JWT Authentication** [cite: 7, 9, 13] |

---

### 🏆 Achievements & Hobbies
* [cite_start]**State-Level Swimmer:** Demonstrating discipline, perseverance, and competitive excellence[cite: 32, 34].
* [cite_start]**Visual Arts:** Passionate about drawing and expressing creativity through design[cite: 33, 34].
